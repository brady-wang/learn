...
$ecms_config['db']['dbserver']='192.168.33.30';	//数据库登录地址
...
//后台安全设置
$ecms_config['esafe']['loginauth']='brady.wang';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='gAIGSHmGUJ7MvxamRgSzCcXf1MwE7D';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='ngtuv';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='bwrtd';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='XPHhKYojNiKiC5ZtXEtYydms2084ku';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='ogrBFaQjehJrXOAzyqUs7WfdFDQYku';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'h7hWTQyFR91HHy1SQy8IYxMr6ibAb1',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/diguo/news/\">新闻中心</a>&nbsp;|&nbsp;<a href=\"/diguo/download/\">下载中心</a>&nbsp;|&nbsp;<a href=\"/diguo/movie/\">影视频道</a>&nbsp;|&nbsp;<a href=\"/diguo/shop/\">网上商城</a>&nbsp;|&nbsp;<a href=\"/diguo/flash/\">FLASH频道</a>&nbsp;|&nbsp;<a href=\"/diguo/photo/\">图片频道</a>&nbsp;|&nbsp;<a href=\"/diguo/article/\">文章中心</a>&nbsp;|&nbsp;<a href=\"/diguo/info/\">分类信息</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
